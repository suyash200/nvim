export declare class API {
    ...
    static readonly v460: API;
    static readonly v470: API;
    static readonly v490: API;
    static readonly v500: API;
    static readonly v510: API;
    static readonly v520: API;
    static readonly v544: API;
    static readonly v540: API;
    static readonly v550: API;
    static readonly v560: API;
