...
export declare namespace ServerResponse {
    ...
    type Response<T extends Proto.Response> = T | Cancelled | typeof NoContent | typeof NoServer;
}
...
export interface ITypeScriptServiceClient {
    ...
    execute<K extends keyof StandardTsServerRequests>(command: K, args: StandardTsServerRequests[K][0], token: vscode.CancellationToken, config?: ExecConfig): Promise<ServerResponse.Response<StandardTsServerRequests[K][1]>>;
    executeWithoutWaitingForResponse<K extends keyof NoResponseTsServerRequests>(command: K, args: NoResponseTsServerRequests[K][0]): void;
    executeAsync<K extends keyof AsyncTsServerRequests>(command: K, args: AsyncTsServerRequests[K][0], token: vscode.CancellationToken): Promise<ServerResponse.Response<Proto.Response>>;
    /**
...
export {};
//# sourceMappingURL=typescriptService.d.ts.map