...
function createCommandsConverter(converter, workspaceService) {
  ...
  return {
    ...
    "editor.action.showReferences": {
      toArgs: (document2, codeLensStart, locations) => [
        document2.toString(),
    ...
    "typescript.findAllFileReferences": {
      fromArgs: (uri) => [import_vscode_uri.URI.parse(uri)],
      toRes: (locations) => locations.map(converter.convertLocation)
    },
    "_typescript.moveToFileRefactoring": {
      toArgs: ({
        ...
        document: document2,
        range
      }) => [action, document2.uri.toString(), converter.convertRangeToLsp(range)],
    ...
    "_typescript.applyCodeActionCommand": {
      toArgs: ({
        ...
        diagnostic,
        document: document2
      }) => [action, converter.convertDiagnosticToLsp(diagnostic), document2.uri.toString()],
...
var lsp, import_vscode_uri;
var init_commandsConverter = __esm({
  "src/share/commandsConverter.ts"() {
    "use strict";
    init_cjs_shims();
    lsp = __toESM(require("vscode-languageserver-protocol"));
    import_vscode_uri = require("vscode-uri");
  }
});
...
var lsp2, CommandsShimService;
var init_commands = __esm({
  "src/shims/commands.ts"() {
    "use strict";
    init_cjs_shims();
    lsp2 = __toESM(require("vscode-languageserver-protocol"));
    init_dispose2();
...
var import_vscode_languageserver_protocol, ConfigurationShimService;
var init_configuration = __esm({
  "src/shims/configuration.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_languageserver_protocol = require("vscode-languageserver-protocol");
    init_dispose2();
    init_objects2();
    init_types();
    ConfigurationShimService = class extends Disposable {
      constructor(defaultConfig) {
        ...
        this._onDidChangeConfiguration = this._register(
          new import_vscode_languageserver_protocol.Emitter()
        );
...
function createContextShim(logPath, hostInfo) {
  return {
    ...
    extensionUri: import_vscode_uri2.URI.from({ scheme: "virtual" })
  };
}
var import_vscode_uri2;
var init_context = __esm({
  "src/shims/context.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_uri2 = require("vscode-uri");
    init_memento();
  }
});

// src/utils/debouncedEmitter.ts
var import_vscode_languageserver_protocol2, DebouncedEmitter;
var init_debouncedEmitter = __esm({
  "src/utils/debouncedEmitter.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_languageserver_protocol2 = require("vscode-languageserver-protocol");
    DebouncedEmitter = class extends import_vscode_languageserver_protocol2.Emitter {
      constructor(delay) {
        super();
        this._cancelCount = 0;
        this._eventBuffer = [];
...
var fs, os, path, rootTempDir, instanceTempDir;
...
var fs2, onCaseInsensitiveFileSystem;
...
function getSemanticSupportedSchemes() {
  if (isWeb() && workspace.workspaceFolders) {
    return workspace.workspaceFolders.map((folder) => folder.uri.scheme);
  }
  return [
    file,
    untitled,
...
var file, untitled, git, github, azurerepos, vsls, walkThroughSnippet, vscodeNotebookCell, officeScript, chatCodeBlock, chatBackingCodeBlock, zipfile, disabledSchemes;
var init_fileSchemes = __esm({
  "src/typescript-language-features/src/configuration/fileSchemes.ts"() {
    ...
    chatBackingCodeBlock = "vscode-copilot-chat-code-block";
    zipfile = "zipfile";
...
var import_vscode_uri3, DiagnosticsShimService, DiagnosticCollection;
var init_diagnostics = __esm({
  "src/shims/diagnostics.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_uri3 = require("vscode-uri");
    ...
    DiagnosticCollection = class _DiagnosticCollection {
      ...
      set(first, diagnostics) {
        ...
        this._checkDisposed();
        let toSync = [];
        if (import_vscode_uri3.URI.isUri(first)) {
          if (!diagnostics) {
            this.delete(first);
            return;
          }
...
function createExtensionsShim() {
  return {
    onDidChange: new import_vscode_languageserver_protocol3.Emitter().event,
    all: [],
    getExtension() {
      return void 0;
    }
...
var init_extensions = __esm({
  "src/shims/extensions.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_languageserver_protocol3 = require("vscode-languageserver-protocol");
  }
});
...
function score(selector, document2) {
  if (Array.isArray(selector)) {
    let ret = 0;
    for (const filter of selector) {
      const value = score(filter, document2);
      if (value === 10) {
        return value;
      }
      if (value > ret) {
    ...
    if (selector === "*") {
      return 5;
    } else if (selector === document2.languageId) {
      return 10;
    } else {
      return 0;
    }
    ...
    let ret = 0;
    if (scheme) {
      if (scheme === document2.uri.scheme) {
        ret = 10;
      } else if (scheme === "*") {
        ret = 5;
      } else {
    ...
    if (language) {
      if (language === document2.languageId) {
        ret = 10;
      } else if (language === "*") {
        ret = Math.max(ret, 5);
      } else {
...
var lsp3, LanguageFeatureRegistry, CodeActionProviderRegistry, CompletionProviderRegistry, ProviderNotFoundError, LanguageFeaturesRegistryStore, LanguageFeaturesShimService;
var init_languageFeatures = __esm({
  "src/shims/languageFeatures.ts"() {
    "use strict";
    init_cjs_shims();
    lsp3 = __toESM(require("vscode-languageserver-protocol"));
    init_barrier();
    init_dispose2();
    init_selector();
...
var import_vscode_uri4, Disposable4, Position, Range, Selection, TextEdit, SnippetTextEdit, WorkspaceEdit, SnippetString, DiagnosticSeverity, Location, DiagnosticRelatedInformation, Diagnostic, Hover, DocumentHighlightKind, DocumentHighlight, MultiDocumentHighlight, SymbolKind, SymbolInformation, DocumentSymbol, CodeAction, _CodeActionKind, CodeActionKind, SelectionRange, CallHierarchyItem, CallHierarchyIncomingCall, CallHierarchyOutgoingCall, CodeLens, BaseMarkdownString, MarkdownString, ParameterInformation, SignatureInformation, SignatureHelp, InlayHintLabelPart, InlayHint, CompletionItemKind, CompletionItem, CompletionList, TextEditorSelectionChangeKind, DataTransferItem, _DocumentDropOrPasteEditKind, DocumentDropOrPasteEditKind, DocumentPasteEdit, RelativePattern, FoldingRange, SemanticTokensLegend, SemanticTokensBuilder, SemanticTokens, LinkedEditingRanges, TabInputText, TabInputTextDiff, TabInputNotebook, CancellationError;
var init_types2 = __esm({
  "src/shims/types.ts"() {
    "use strict";
    init_cjs_shims();
    import_vscode_uri4 = require("vscode-uri");
    init_fs();
    init_objects2();
    init_resourceMap2();
    init_uuid();
    ...
    Location = class _Location {
      static isLocation(thing) {
        ...
        return Range.isRange(thing.range) && import_vscode_uri4.URI.isUri(thing.uri);
      }
    ...
    DiagnosticRelatedInformation = class {
      static is(thing) {
        ...
        return typeof thing.message === "string" && thing.location && Range.isRange(thing.location.range) && import_vscode_uri4.URI.isUri(thing.location.uri);
      }
    ...
    RelativePattern = class {
      ...
      set base(base) {
        this._base = base;
        this._baseUri = import_vscode_uri4.URI.file(base);
      }
      get baseUri() {
      ...
      constructor(base, pattern) {
        if (typeof base !== "string") {
          if (!base || !import_vscode_uri4.URI.isUri(base) && !import_vscode_uri4.URI.isUri(base.uri)) {
        ...
        if (typeof base === "string") {
          this.baseUri = import_vscode_uri4.URI.file(base);
        } else if (import_vscode_uri4.URI.isUri(base)) {
          this.baseUri = base;
        } else {
...
var lsp4, OutputChannel, LogOutputChannel;
var init_log = __esm({
  "src/shims/log.ts"() {
    "use strict";
    init_cjs_shims();
    lsp4 = __toESM(require("vscode-languageserver-protocol"));
    init_dispose2();
...
// src/shims/window.ts
var lsp5, WindowShimService;
var init_window = __esm({
  "src/shims/window.ts"() {
    "use strict";
    init_cjs_shims();
    lsp5 = __toESM(require("vscode-languageserver-protocol"));
    init_dispose2();
    init_types();
    init_log();
    WindowShimService = class extends Disposable {
      ...
      showTextDocument(document2) {
        return this.delegate.openTextDocument(document2.uri.toString(), true);
      }
...
async function symLinkStat(path15) {
  let lstats;
  try {
    lstats = await import_fs5.promises.lstat(path15);
  ...
  try {
    const stats = await import_fs5.promises.stat(path15);
    return {
      stat: stats,
    ...
    if (process.platform === "win32" && error.code === "EACCES") {
      try {
        const stats = await import_fs5.promises.stat(await import_fs5.promises.readlink(path15));
...
var lsp6, import_vscode_languageserver_textdocument, import_vscode_uri5, IsomorphicTextDocument, DocumentLine;
var init_textdocument = __esm({
  "src/shims/textdocument.ts"() {
    "use strict";
    init_cjs_shims();
    lsp6 = __toESM(require("vscode-languageserver-protocol"));
    import_vscode_languageserver_textdocument = require("vscode-languageserver-textdocument");
    import_vscode_uri5 = require("vscode-uri");
    init_types2();
    init_word();
    IsomorphicTextDocument = class _IsomorphicTextDocument {
      constructor($documentModel) {
        ...
        this.uri = import_vscode_uri5.URI.parse($documentModel.uri);
      }
      static create(uri, languageId, version, content) {
        const documentModel = import_vscode_languageserver_textdocument.TextDocument.create(uri, languageId, version, content);
        return new _IsomorphicTextDocument(documentModel);
      }
      static update(document2, changes, version) {
        import_vscode_languageserver_textdocument.TextDocument.update(document2.$documentModel, changes, version);
      }
      static applyEdits(document2, edits) {
        import_vscode_languageserver_textdocument.TextDocument.applyEdits(document2.$documentModel, edits);
      }
      get version() {
...
var path2, lsp7, import_vscode_uri6, DocumentNotOpenedError, WorkspaceShimService;
var init_workspace = __esm({
  "src/shims/workspace.ts"() {
    "use strict";
    init_cjs_shims();
    path2 = __toESM(require("path"));
    lsp7 = __toESM(require("vscode-languageserver-protocol"));
    import_vscode_uri6 = require("vscode-uri");
    init_barrier();
    init_dispose2();
    init_fs();
    init_resourceMap2();
    ...
    WorkspaceShimService = class extends Disposable {
      constructor(delegate, configurationShim, initWorkspaceFolders) {
        ...
        for (const f of initWorkspaceFolders ?? []) {
          ...
          const uri = import_vscode_uri6.URI.parse(f.uri);
          this._workspaceFolders.set(uri, {
            name: f.name || import_vscode_uri6.Utils.basename(uri),
            index: id,
            uri
          });
        }
      ...
      $getOpenedDoc(uri) {
        return this._documents.get(import_vscode_uri6.URI.parse(uri));
      }
      ...
      $openTextDocument(params) {
        ...
        this._documents.set(import_vscode_uri6.URI.parse(uri), doc);
      ...
      $changeTextDocument(params) {
        ...
        const doc = this._documents.get(import_vscode_uri6.URI.parse(uri));
        if (!doc) {
      ...
      $closeTextDocument(params) {
        ...
        const vsUri = import_vscode_uri6.URI.parse(uri);
      ...
      $changeWorkspaceFolders(params) {
        ...
        event.added.forEach((folder) => {
          const uri = import_vscode_uri6.URI.parse(folder.uri);
          const addFolder = {
            name: folder.name,
      ...
      $renameFiles(params) {
        const renamedFiles = params.files.map(({ newUri, oldUri }) => ({
          newUri: import_vscode_uri6.URI.parse(newUri),
          oldUri: import_vscode_uri6.URI.parse(oldUri)
        }));
      ...
      asRelativePath(pathOrUri, includeWorkspace) {
        const uri = import_vscode_uri6.URI.isUri(pathOrUri) ? pathOrUri : import_vscode_uri6.URI.file(pathOrUri);
      ...
      async openTextDocument(nameOrUri) {
        const uri = typeof nameOrUri === "string" ? import_vscode_uri6.URI.file(nameOrUri) : nameOrUri;
...
var l10n, os2, import_vscode_languageserver_protocol4, import_vscode_uri7, import_vscode_languageserver_protocol5, extensions, languages, commands, window, env, workspace, chat, EventEmitter, Uri;
var init_shims = __esm({
  "src/shims/index.ts"() {
    "use strict";
    init_cjs_shims();
    l10n = __toESM(require("@vscode/l10n"));
    os2 = __toESM(require("os"));
    import_vscode_languageserver_protocol4 = require("vscode-languageserver-protocol");
    import_vscode_uri7 = require("vscode-uri");
    init_chat();
    init_commands();
    init_configuration();
    init_context();
    ...
    init_window();
    init_workspace();
    import_vscode_languageserver_protocol5 = require("vscode-languageserver-protocol");
    init_fs3();
    init_log();
    init_types2();
    extensions = createExtensionsShim();
    EventEmitter = import_vscode_languageserver_protocol4.Emitter;
    Uri = new Proxy(import_vscode_uri7.URI, {
      get(target, p) {
        return target[p] ?? import_vscode_uri7.Utils[p];
      }
    });
  }
});
...
var init_api2 = __esm({
  "src/typescript-language-features/src/tsServer/api.ts"() {
    ...
    _API.v550 = _API.fromSimpleString("5.5.0");
...
var init_tsserverRequests = __esm({
  "src/typescript-language-features/src/commands/tsserverRequests.ts"() {
    ...
    TSServerRequestCommand = class {
      ...
      execute(requestID, args, config3) {
        ...
        return this.lazyClientHost.value.serviceClient.execute(requestID, args, token, config3);
      }
    };
  }
});
...
function isJsConfigOrTsConfigFileName(fileName) {
  return /^[jt]sconfig\.(.+\.)?json$/i.test((0, import_path.basename)(fileName));
}
...
var import_path, standardLanguageDescriptions;
...
var path3, FileConfigurationManager, InlayHintSettingNames;
var init_fileConfigurationManager = __esm({
  "src/typescript-language-features/src/languageFeatures/fileConfigurationManager.ts"() {
    ...
    FileConfigurationManager = class extends Disposable {
      ...
      async ensureConfigurationForDocument(document2, token) {
        const formattingOptions = this.getFormattingOptions(document2);
        return this.ensureConfigurationOptions(document2, formattingOptions, token);
      }
      getFormattingOptions(document2) {
        return;
      }
      async ensureConfigurationOptions(document2, options, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return;
        }
        const currentOptions = this.getFileOptions(document2, options);
        const cachedOptions = this.formatOptions.get(document2.uri);
        if (cachedOptions) {
        ...
        this.formatOptions.set(document2.uri, task);
        await task;
      }
      async setGlobalConfigurationFromDocument(document2, token) {
        const args = {
          file: void 0,
          ...this.getFileOptions(document2)
        };
      ...
      getFileOptions(document2, options) {
        return {
          formatOptions: this.getFormatOptions(document2, options),
          preferences: this.getPreferences(document2)
        };
      }
      getFormatOptions(document2, options) {
        const config3 = workspace.getConfiguration(
          isTypeScriptDocument(document2) ? "typescript.format" : "javascript.format",
          document2.uri
        );
        const tsEditorConfig = workspace.getConfiguration(
          isTypeScriptDocument(document2) ? "vtsls.typescript.format" : "vtsls.javascript.format",
          document2.uri
        );
        return {
      ...
      getPreferences(document2) {
        var _a;
        const config3 = workspace.getConfiguration(
          isTypeScriptDocument(document2) ? "typescript" : "javascript",
          document2
        );
        const preferencesConfig = workspace.getConfiguration(
          isTypeScriptDocument(document2) ? "typescript.preferences" : "javascript.preferences",
          document2
        );
        const preferences = {
          ...
          allowTextChangesInNewFiles: document2.uri.scheme === file,
          ...
          autoImportFileExcludePatterns: this.getAutoImportFileExcludePatternsPreference(preferencesConfig, (_a = workspace.getWorkspaceFolder(document2.uri)) == null ? void 0 : _a.uri),
      ...
      getOrganizeImportsPreferences(config3) {
        return {
          ...
          organizeImportsCaseFirst: withDefaultAsUndefined(config3.get("organizeImports.caseFirst", "default"), "default"),
          organizeImportsCollation: config3.get("organizeImports.collation"),
          organizeImportsIgnoreCase: withDefaultAsUndefined(config3.get("organizeImports.caseSensitivity"), "auto"),
...
var init_cachedResponse = __esm({
  "src/typescript-language-features/src/tsServer/cachedResponse.ts"() {
    ...
    CachedResponse = class {
       ...
       */
      execute(document2, resolve) {
        if (this.response && this.matches(document2)) {
          return this.response = this.response.then((result) => result.type === "cancelled" ? resolve() : result);
        }
        return this.reset(document2, resolve);
      }
      matches(document2) {
        return this.version === document2.version && this.document === document2.uri.toString();
      }
      async reset(document2, resolve) {
        this.version = document2.version;
        this.document = document2.uri.toString();
...
var path4, TypeScriptCallHierarchySupport;
  ...
  "src/typescript-language-features/src/languageFeatures/callHierarchy.ts"() {
    ...
    TypeScriptCallHierarchySupport = class {
      ...
      async prepareCallHierarchy(document2, position, token) {
        const filepath = this.client.toOpenTsFilePath(document2);
        if (!filepath) {
          return void 0;
        }
...
function getSymbolRange(document2, item) {
  var _a;
  if (item.nameSpan) {
  ...
  const startOffset = document2.offsetAt(new Position(range.start.line, range.start.character)) + prefixLength;
  return new Range(
    document2.positionAt(startOffset),
    document2.positionAt(startOffset + item.text.length)
  );
}
...
var init_baseCodeLensProvider = __esm({
  "src/typescript-language-features/src/languageFeatures/codeLens/baseCodeLensProvider.ts"() {
    ...
    ReferencesCodeLens = class extends CodeLens {
      constructor(document2, file2, range) {
        super(range);
    ...
    TypeScriptBaseCodeLensProvider = class extends Disposable {
      ...
      async provideCodeLenses(document2, token) {
        ...
        const response = await this.cachedResponse.execute(document2, () => this.client.execute("navtree", { file: filepath }, token));
        if (response.type !== "response") {
          return [];
        }
        const referenceableSpans = [];
        (_b = (_a = response.body) == null ? void 0 : _a.childItems) == null ? void 0 : _b.forEach((item) => this.walkNavTree(document2, item, void 0, referenceableSpans));
        return referenceableSpans.map((span) => new ReferencesCodeLens(document2.uri, filepath, span));
      }
      walkNavTree(document2, item, parent, results) {
        var _a;
        const range = this.extractSymbol(document2, item, parent);
        if (range) {
          results.push(range);
        }
        (_a = item.childItems) == null ? void 0 : _a.forEach((child) => this.walkNavTree(document2, child, item, results));
      }
    };
    ...
    _RequestRouter = class _RequestRouter {
      ...
      execute(command, args, executeInfo) {
        if (_RequestRouter.sharedCommands.has(command) && typeof executeInfo.executionTarget === "undefined") {
          ...
          let token = void 0;
          if (executeInfo.token) {
            const source = new import_vscode_languageserver_protocol5.CancellationTokenSource();
            executeInfo.token.onCancellationRequested(() => {
...
var init_implementationsCodeLens = __esm({
  "src/typescript-language-features/src/languageFeatures/codeLens/implementationsCodeLens.ts"() {
    ...
    TypeScriptImplementationsCodeLensProvider = class extends TypeScriptBaseCodeLensProvider {
      ...
      extractSymbol(document2, item, parent) {
        if (item.kind === Kind.method && parent && parent.kind === Kind.interface && workspace.getConfiguration(this.language.id).get("implementationsCodeLens.showOnInterfaceMethods")) {
          return getSymbolRange(document2, item);
        }
        switch (item.kind) {
          case Kind.interface:
            return getSymbolRange(document2, item);
...
var init_completions = __esm({
  "src/typescript-language-features/src/languageFeatures/completions.ts"() {
    ...
    MyCompletionItem = class _MyCompletionItem extends CompletionItem {
      constructor(position, document2, tsEntry, completionContext, metadata, client, defaultCommitCharacters) {
      ...
      async resolveCompletionItem(client, token) {
        ...
        const requestToken = new import_vscode_languageserver_protocol5.CancellationTokenSource();
        const promise = (async () => {
          var _a;
      ...
      async isValidFunctionCompletionContext(client, filepath, position, document2, token) {
        try {
          const args = Position3.toFileLocationRequestArgs(filepath, position);
    ...
    TypeScriptCompletionItemProvider = class {
      ...
      async provideCompletionItems(document2, position, token, context) {
        var _a;
        if (!workspace.getConfiguration(this.language.id, document2).get("suggest.enabled")) {
          return void 0;
        }
        ...
        const line = document2.lineAt(position.line);
        const completionConfiguration = CompletionConfiguration.getConfigurationForResource(this.language.id, document2.uri);
        ...
        if (wordRange && !wordRange.isEmpty) {
          ...
          const firstChar = document2.getText(new Range(wordRange.start, secondCharPosition));
          if (firstChar === "@") {
            wordRange = wordRange.with(secondCharPosition);
          }
        }
        await this.client.interruptGetErr(() => this.fileConfigurationManager.ensureConfigurationForDocument(document2, token));
        const args = {
...
function register5(selector, language, client) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */),
    requireMinVersion(client, API.v560),
    requireGlobalConfiguration(language.id, settingId)
  ], () => {
    return languages.registerDocumentPasteEditProvider(selector.semantic, new DocumentPasteProvider(language.id, client), {
...
var CopyMetadata, settingId, _DocumentPasteProvider, DocumentPasteProvider;
var init_copyPaste = __esm({
  "src/typescript-language-features/src/languageFeatures/copyPaste.ts"() {
    ...
    settingId = "experimental.updateImportsOnPaste";
    _DocumentPasteProvider = class _DocumentPasteProvider {
      constructor(_modeId, _client) {
        this._modeId = _modeId;
        this._client = _client;
      }
      prepareDocumentPaste(document2, ranges, dataTransfer, _token) {
        dataTransfer.set(
          _DocumentPasteProvider.metadataMimeType,
          new DataTransferItem(new CopyMetadata(document2.uri, ranges).toJSON())
        );
      }
      async provideDocumentPasteEdits(document2, ranges, dataTransfer, _context, token) {
        var _a, _b;
        const config3 = workspace.getConfiguration(this._modeId, document2.uri);
        if (!config3.get(settingId, false)) {
          return;
        }
        const file2 = this._client.toOpenTsFilePath(document2);
        if (!file2) {
          return;
        }
    ...
    _DocumentPasteProvider.kind = DocumentDropOrPasteEditKind.Empty.append("text", "jsts", "pasteWithImports");
...
var init_definitionProviderBase = __esm({
  "src/typescript-language-features/src/languageFeatures/definitionProviderBase.ts"() {
    ...
    TypeScriptDefinitionProviderBase = class {
      ...
      async getSymbolLocations(definitionType, document2, position, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return void 0;
        }
  ...
  "src/typescript-language-features/src/languageFeatures/definitions.ts"() {
    ...
    TypeScriptDefinitionProvider = class extends TypeScriptDefinitionProviderBase {
      async provideDefinition(document2, position, token) {
        ...
        if (workspace.getConfiguration(document2.languageId).get("preferGoToSourceDefinition", false) && this.client.apiVersion.gte(API.v470)) {
  ...
  "src/typescript-language-features/src/languageFeatures/directiveCommentCompletions.ts"() {
    ...
    DirectiveCommentCompletionProvider = class {
      ...
      provideCompletionItems(document2, position, _token) {
        ...
        const line = document2.lineAt(position.line).text;
...
var init_documentHighlight = __esm({
  "src/typescript-language-features/src/languageFeatures/documentHighlight.ts"() {
    ...
    TypeScriptDocumentHighlightProvider = class {
      ...
      async provideMultiDocumentHighlights(document2, position, otherDocuments, token) {
        const allFiles = [document2, ...otherDocuments].map((doc) => this.client.toOpenTsFilePath(doc)).filter((file3) => !!file3);
        const file2 = this.client.toOpenTsFilePath(document2);
  ...
  "src/typescript-language-features/src/languageFeatures/documentSymbol.ts"() {
    ...
    TypeScriptDocumentSymbolProvider = class _TypeScriptDocumentSymbolProvider {
      ...
      async provideDocumentSymbols(document2, token) {
        ...
        const response = await this.cachedResponse.execute(document2, () => this.client.execute("navtree", args, token));
        if (response.type !== "response" || !((_a = response.body) == null ? void 0 : _a.childItems)) {
          return void 0;
        }
        const result = [];
        for (const item of response.body.childItems) {
          _TypeScriptDocumentSymbolProvider.convertNavTree(document2.uri, result, item);
        }
        return result;
      }
  ...
  "src/typescript-language-features/src/languageFeatures/fileReferences.ts"() {
    ...
    _FileReferencesCommand = class _FileReferencesCommand {
      ...
      async execute(resource) {
        ...
        const document2 = await workspace.openTextDocument(resource);
        if (!isSupportedLanguageMode(document2)) {
          window.showErrorMessage(l10n.t("Find file references failed. Unsupported file type."));
          return;
        }
        const openedFiledPath = this.client.toOpenTsFilePath(document2);
        if (!openedFiledPath) {
...
var init_fixAll = __esm({
  "src/typescript-language-features/src/languageFeatures/fixAll.ts"() {
    ...
    _TypeScriptAutoFixProvider = class _TypeScriptAutoFixProvider {
      ...
      async provideCodeActions(document2, _range, context, token) {
        ...
        const diagnostics = this.diagnosticsManager.getDiagnostics(document2.uri);
        if (!diagnostics.length) {
          return actions;
        }
        await this.fileConfigurationManager.ensureConfigurationForDocument(document2, token);
        if (token.isCancellationRequested) {
          return void 0;
        }
...
var init_folding = __esm({
  "src/typescript-language-features/src/languageFeatures/folding.ts"() {
    ...
    _TypeScriptFoldingProvider = class _TypeScriptFoldingProvider {
      ...
      async provideFoldingRanges(document2, _context, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return;
        }
        ...
        return coalesce(response.body.map((span) => this.convertOutliningSpan(span, document2)));
      }
      convertOutliningSpan(span, document2) {
        const range = Range4.fromTextSpan(span.textSpan);
        const kind = _TypeScriptFoldingProvider.getFoldingRangeKind(span);
        if (span.kind === "comment") {
          const line = document2.lineAt(range.start.line).text;
          if (/\/\/\s*#endregion/gi.test(line)) {
            return void 0;
          }
        }
        const start = range.start.line;
        const end = this.adjustFoldingEnd(range, document2);
        return new FoldingRange(start, end, kind);
      }
      adjustFoldingEnd(range, document2) {
        if (range.end.character > 0) {
          const foldEndCharacter = document2.getText(new Range(range.end.translate(0, -1), range.end));
  ...
  "src/typescript-language-features/src/languageFeatures/formatting.ts"() {
    ...
    TypeScriptFormattingProvider = class {
      ...
      async provideDocumentRangeFormattingEdits(document2, range, options, token) {
        ...
        await this.formattingOptionsManager.ensureConfigurationOptions(document2, options, token);
      ...
      async provideOnTypeFormattingEdits(document2, position, ch, options, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return [];
        }
        ...
        for (const edit of response.body) {
          ...
          if (range.start.character === 0 && range.start.line === range.end.line && textEdit.newText === "") {
            const lText = document2.lineAt(range.start.line).text;
  ...
  "src/typescript-language-features/src/languageFeatures/hover.ts"() {
    ...
    TypeScriptHoverProvider = class {
      ...
      async provideHover(document2, position, token) {
        ...
        return new Hover(
          this.getContents(document2.uri, response.body, response._serverType),
          Range4.fromTextSpan(response.body)
        );
      }
  ...
  "src/typescript-language-features/src/languageFeatures/implementations.ts"() {
    ...
    TypeScriptImplementationProvider = class extends TypeScriptDefinitionProviderBase {
      provideImplementation(document2, position, token) {
        return this.getSymbolLocations("implementation", document2, position, token);
      }
    };
  }
});
...
function areInlayHintsEnabledForFile(language, document2) {
  const config3 = workspace.getConfiguration(language.id, document2);
 ...
 */`);
    JsDocCompletionItem = class extends CompletionItem {
      constructor(document2, position) {
        super("/** */", 0 /* Text */);
        this.document = document2;
        this.position = position;
    ...
    JsDocCompletionProvider = class {
      ...
      async provideCompletionItems(document2, position, token) {
        if (!workspace.getConfiguration(this.language.id, document2).get("suggest.completeJSDocs")) {
          return void 0;
        }
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
        ...
        if (!this.isPotentiallyValidDocCompletionPosition(document2, position)) {
          return void 0;
        }
        const response = await this.client.interruptGetErr(async () => {
          await this.fileConfigurationManager.ensureConfigurationForDocument(document2, token);
        ...
        const item = new JsDocCompletionItem(document2, position);
      ...
      isPotentiallyValidDocCompletionPosition(document2, position) {
        const line = document2.lineAt(position.line).text;
        const prefix = line.slice(0, position.character);
        ...
        return Disposable4.from(
          ...
          ...command.commandIds.map((id) => commandManager.register({
            ...
            async execute(filePath) {
              const document2 = await workspace.openTextDocument(filePath);
...
var init_organizeImports = __esm({
  "src/typescript-language-features/src/languageFeatures/organizeImports.ts"() {
    ...
    ImportCodeAction = class extends CodeAction {
      constructor(title, kind, document2) {
        super(title, kind);
        this.document = document2;
      }
    };
    ImportsCodeActionProvider = class {
      ...
      provideCodeActions(document2, _range, context, _token) {
        ...
        return [new ImportCodeAction(this.commandMetadata.title, this.commandMetadata.kind, document2)];
      }
...
async function findScopeEndLineFromNavTree(client, document2, startLine) {
  var _a;
  const filepath = client.toOpenTsFilePath(document2);
  if (!filepath) {
    return;
  }
...
async function findEditScope(client, document2, edits) {
  ...
  const start = startIndex > -1 ? document2.positionAt(startIndex) : first;
  const endIndex = text.lastIndexOf(lastEdit.newText);
  const end = endIndex > -1 ? document2.positionAt(endIndex + lastEdit.newText.length) : last;
...
var init_copilot = __esm({
  "src/typescript-language-features/src/languageFeatures/util/copilot.ts"() {
    ...
    _EditorChatFollowUp = class _EditorChatFollowUp {
      ...
      async execute({ message, document: document2, expand, action }) {
...
var init_quickFix = __esm({
  "src/typescript-language-features/src/languageFeatures/quickFix.ts"() {
    ...
    _ApplyCodeActionCommand = class _ApplyCodeActionCommand {
      ...
      async execute({ document: document2, action, diagnostic, followupAction }) {
        this.telemetryReporter.logTelemetry("quickFix.execute", {
          fixName: action.fixName
        });
        this.diagnosticManager.deleteDiagnostic(document2.uri, diagnostic);
    ...
    _TypeScriptQuickFixProvider = class _TypeScriptQuickFixProvider {
      ...
      async provideCodeActions(document2, range, context, token) {
        ...
        if (this.client.bufferSyncSupport.hasPendingDiagnostics(document2.uri)) {
          ...
          for (const diagnostic of this.diagnosticsManager.getDiagnostics(document2.uri)) {
        ...
        await this.formattingConfigurationManager.ensureConfigurationForDocument(document2, token);
        if (token.isCancellationRequested) {
          return;
        }
        const results = new CodeActionSet();
        for (const diagnostic of fixableDiagnostics.values) {
          await this.getFixesForDiagnostic(document2, file2, diagnostic, results, token);
          if (token.isCancellationRequested) {
            return;
          }
        }
      ...
      async getFixesForDiagnostic(document2, file2, diagnostic, results, token) {
        const args = {
          ...Range4.toFileRangeRequestArgs(file2, diagnostic.range),
          errorCodes: [+diagnostic.code]
        };
        ...
        for (const tsCodeFix of response.body) {
          for (const action of this.getFixesForTsCodeAction(document2, diagnostic, tsCodeFix)) {
            results.addAction(action);
          }
          this.addFixAllForTsCodeAction(results, document2.uri, file2, diagnostic, tsCodeFix);
        }
        return results;
      }
      getFixesForTsCodeAction(document2, diagnostic, action) {
        var _a;
        const actions = [];
        ...
        codeAction.command = {
          ...
          arguments: commandsConverter[ApplyCodeActionCommand.ID].toArgs({ action, diagnostic, document: document2 }),
          title: ""
        };
        ...
        if (copilot == null ? void 0 : copilot.isActive) {
          ...
          if (action.fixName === classIncorrectlyImplementsInterface) {
            title += " with Copilot";
            message = `Implement the stubbed-out class members for ${document2.getText(diagnostic.range)} with a useful implementation.`;
            ...
            title = `Implement missing function declaration '${document2.getText(diagnostic.range)}' using Copilot`;
            message = `Provide a reasonable implementation of the function ${document2.getText(diagnostic.range)} given its type and the context it's called in.`;
            expand = { kind: "code-action", action };
          ...
          if (expand && message !== void 0) {
            ...
            (_a = aiCodeAction.edit) == null ? void 0 : _a.insert(document2.uri, diagnostic.range.start, "");
            ...
            aiCodeAction.command = {
              ...
              arguments: [{
                command: ApplyCodeActionCommand.ID,
                arguments: [{ action, diagnostic, document: document2 }],
                title: ""
              }, {
                command: EditorChatFollowUp.ID,
                title: "",
...
var init_refactor = __esm({
  "src/typescript-language-features/src/languageFeatures/refactor.ts"() {
    ...
    init_shims();
    import_vscode_uri9 = require("vscode-uri");
    init_learnMoreAboutRefactorings();
    init_fileSchemes();
    init_schemes();
    init_api2();
    ...
    _MoveToFileRefactorCommand = class _MoveToFileRefactorCommand {
      ...
      async getTargetFile(document2, file2, range) {
        ...
        const workspaceFolder = workspace.getWorkspaceFolder(document2.uri);
        ...
        const updateItems = () => {
          ...
          const destinationItems = body.files.map((file3) => {
            ...
            const parentDir = import_vscode_uri9.Utils.dirname(uri);
            const filename = import_vscode_uri9.Utils.basename(uri);
            let description2;
            if (workspaceFolder) {
              ...
              if (relativeQuery) {
                ...
                const relativePath = convertRelativePath(path5.relative(path5.dirname(document2.uri.fsPath), uri.fsPath));
            ...
            return {
              file: file3,
              label: import_vscode_uri9.Utils.basename(uri),
        ...
        if (picked === selectExistingFileItem) {
          const picked2 = await window.showOpenDialog({
            ...
            defaultUri: import_vscode_uri9.Utils.dirname(document2.uri)
          });
    ...
    InlinedCodeAction = class _InlinedCodeAction extends CodeAction {
      constructor(client, document2, refactor, action, range, trigger) {
    ...
    MoveToFileCodeAction = class extends CodeAction {
      constructor(document2, action, range, trigger) {
        ...
        this.command = {
          ...
          arguments: commandsConverter[MoveToFileRefactorCommand.ID].toArgs(...[{ action, document: document2, range, trigger }])
        };
      }
    };
    SelectCodeAction = class extends CodeAction {
      constructor(info, document2, rangeOrSelection, trigger) {
        super(info.description, CodeActionKind.Refactor);
        this.command = {
          title: info.description,
          command: SelectRefactorCommand.ID,
          arguments: commandsConverter[SelectRefactorCommand.ID].toArgs(...[{ action: this, document: document2, refactor: info, rangeOrSelection, trigger }])
        };
      }
    };
    _TypeScriptRefactorProvider = class _TypeScriptRefactorProvider {
      ...
      async provideCodeActions(document2, rangeOrSelection, context, token) {
        if (!this.shouldTrigger(context, rangeOrSelection)) {
          return void 0;
        }
        if (!this.client.toOpenTsFilePath(document2)) {
          return void 0;
        }
        const response = await this.interruptGetErrIfNeeded(context, () => {
          ...
          this.formattingOptionsManager.ensureConfigurationForDocument(document2, token);
          const args = {
        ...
        const applicableRefactors = this.convertApplicableRefactors(document2, context, response.body, rangeOrSelection);
        const actions = coalesce(await Promise.all(Array.from(applicableRefactors, async (action) => {
          ...
          if (this.client.apiVersion.lt(API.v540) && context.triggerKind === 2 /* Automatic */) {
            if (((_b = action.kind) == null ? void 0 : _b.value) === Move_NewFile.kind.value || ((_c = action.kind) == null ? void 0 : _c.value) === Move_File.kind.value) {
              ...
              const navTree = await this.cachedNavTree.execute(document2, () => this.client.execute("navtree", { file: file2 }, token));
      ...
      *convertApplicableRefactors(document2, context, refactors, rangeOrSelection) {
        for (const refactor of refactors) {
          if (refactor.inlineable === false) {
            yield new SelectCodeAction(refactor, document2, rangeOrSelection, context.triggerKind);
          } else {
            for (const action of refactor.actions) {
              for (const codeAction of this.refactorActionToCodeActions(document2, context, refactor, action, rangeOrSelection, refactor.actions)) {
                yield codeAction;
              }
            }
          }
      ...
      refactorActionToCodeActions(document2, context, refactor, action, rangeOrSelection, allActions) {
        const codeActions = [];
        if (action.name === "Move to file") {
          codeActions.push(new MoveToFileCodeAction(document2, action, rangeOrSelection, context.triggerKind));
        } else {
          codeActions.push(new InlinedCodeAction(this.client, document2, refactor, action, rangeOrSelection, context.triggerKind));
        }
...
var init_references = __esm({
  "src/typescript-language-features/src/languageFeatures/references.ts"() {
    ...
    TypeScriptReferenceSupport = class {
      ...
      async provideReferences(document2, position, options, token) {
        const filepath = this.client.toOpenTsFilePath(document2);
        if (!filepath) {
          return [];
        }
...
var path6, TypeScriptRenameProvider;
  ...
  "src/typescript-language-features/src/languageFeatures/rename.ts"() {
    ...
    TypeScriptRenameProvider = class {
      ...
      async prepareRename(document2, position, token) {
        const response = await this.execRename(document2, position, token);
        if (!response) {
          return void 0;
        }
      ...
      async execRename(document2, position, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return void 0;
        }
        if (this.client.apiVersion.gte(API.v510) && workspace.getConfiguration(this.language.id).get("preferences.renameMatchingJsxTags", true) && this.looksLikePotentialJsxTagContext(document2, position)) {
        ...
        return this.client.interruptGetErr(async () => {
          this.fileConfigurationManager.ensureConfigurationForDocument(document2, token);
      ...
      looksLikePotentialJsxTagContext(document2, position) {
        if (![typescriptreact, javascript, javascriptreact].includes(document2.languageId)) {
          return false;
        }
        const prefix = document2.getText(new Range(position.line, 0, position.line, position.character));
...
function waitForDocumentChangesToEnd(document2) {
  let version = document2.version;
  return new Promise((resolve) => {
    const iv = setInterval((_) => {
      if (document2.version === version) {
        clearInterval(iv);
        resolve();
      }
  ...
  "src/typescript-language-features/src/languageFeatures/semanticTokens.ts"() {
    ...
    DocumentSemanticTokensProvider = class {
      ...
      async provideDocumentSemanticTokens(document2, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2 || document2.getText().length > CONTENT_LENGTH_LIMIT) {
          return null;
        }
        return this.provideSemanticTokens(document2, { file: file2, start: 0, length: document2.getText().length }, token);
      }
      async provideDocumentRangeSemanticTokens(document2, range, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2 || document2.offsetAt(range.end) - document2.offsetAt(range.start) > CONTENT_LENGTH_LIMIT) {
          return null;
        }
        const start = document2.offsetAt(range.start);
        const length = document2.offsetAt(range.end) - start;
        return this.provideSemanticTokens(document2, { file: file2, start, length }, token);
      }
      async provideSemanticTokens(document2, requestArg, token) {
        const file2 = this.client.toOpenTsFilePath(document2);
        if (!file2) {
          return null;
        }
        const versionBeforeRequest = document2.version;
        const response = await this.client.execute("encodedSemanticClassifications-full", { ...requestArg, format: "2020" }, token, {
          cancelOnResourceChange: document2.uri
        });
        if (response.type !== "response" || !response.body) {
          return null;
        }
        const versionAfterRequest = document2.version;
        if (versionBeforeRequest !== versionAfterRequest) {
          await waitForDocumentChangesToEnd(document2);
        ...
        for (let i = 0; i < tokenSpan.length; ) {
          ...
          const startPos = document2.positionAt(offset);
          const endPos = document2.positionAt(offset + length);
          for (let line = startPos.line; line <= endPos.line; line++) {
            const startCharacter = line === startPos.line ? startPos.character : 0;
            const endCharacter = line === endPos.line ? endPos.character : document2.lineAt(line).text.length;
  ...
  "src/typescript-language-features/src/languageFeatures/signatureHelp.ts"() {
    ...
    TypeScriptSignatureHelpProvider = class {
      ...
      async provideSignatureHelp(document2, position, token, context) {
        ...
        result.signatures = info.items.map((signature) => this.convertSignature(signature, document2.uri));
...
var init_sourceDefinition = __esm({
  "src/typescript-language-features/src/languageFeatures/sourceDefinition.ts"() {
    ...
    _SourceDefinitionCommand = class _SourceDefinitionCommand {
      ...
      async execute(document2, position) {
...
var init_tagClosing = __esm({
  "src/typescript-language-features/src/languageFeatures/tagClosing.ts"() {
    ...
    TagClosing = class extends Disposable {
      ...
      onDidChangeTextDocument({ document: document2, contentChanges, reason }) {
        var _a;
        ...
        const priorCharacter = lastChange.range.start.character > 0 ? document2.getText(new Range(lastChange.range.start.translate({ characterDelta: -1 }), lastChange.range.start)) : "";
        if (priorCharacter === ">") {
          return;
        }
        ...
        this._timeout = setTimeout(async () => {
          ...
          const args = Position3.toFileLocationRequestArgs(filepath, position);
          this._cancel = new import_vscode_languageserver_protocol5.CancellationTokenSource();
          ...
          if (document2 === activeDocument2 && activeDocument2.version === version) {
  ...
  "src/typescript-language-features/src/languageFeatures/typeDefinitions.ts"() {
    ...
    TypeScriptTypeDefinitionProvider = class extends TypeScriptDefinitionProviderBase {
      provideTypeDefinition(document2, position, token) {
        return this.getSymbolLocations("typeDefinition", document2, position, token);
      }
    };
  }
});
...
var import_path2, validateSetting, suggestionSetting, LanguageProvider;
    ...
    LanguageProvider = class extends Disposable {
      ...
      async registerProviders() {
        ...
        await Promise.all([
          ...
          Promise.resolve().then(() => (init_copyPaste(), copyPaste_exports)).then((provider) => this._register(provider.register(selector, this.description, this.client))),
      ...
      handlesUri(resource) {
        const ext = (0, import_path2.extname)(resource.path).slice(1).toLowerCase();
      ...
      handlesConfigFile(resource) {
        const base = (0, import_path2.basename)(resource.fsPath);
...
var TsServerLogLevel, ImplicitProjectConfiguration, BaseServiceConfigurationProvider;
  ...
  "src/typescript-language-features/src/configuration/configuration.ts"() {
    ...
    BaseServiceConfigurationProvider = class {
      ...
      readUseVsCodeWatcher(configuration) {
        ...
        return configuration.get("typescript.tsserver.experimental.useVsCodeWatcher", true);
      }
...
var init_bufferSyncSupport = __esm({
  "src/typescript-language-features/src/tsServer/bufferSyncSupport.ts"() {
    ...
    SyncedBuffer = class {
      constructor(document2, filepath, client, synchronizer) {
        this.document = document2;
      ...
      getProjectRootPath(resource) {
        ...
        return isOfScheme(resource, officeScript, chatCodeBlock, chatBackingCodeBlock) ? "/" : void 0;
      }
      get resource() {
    ...
    GetErrRequest = class _GetErrRequest {
      constructor(client, files, onDone) {
        ...
        this.files = files;
        this._done = false;
        this._token = new import_vscode_languageserver_protocol5.CancellationTokenSource();
    ...
    BufferSyncSupport = class extends Disposable {
      ...
      listen() {
        ...
        window.onDidChangeVisibleTextEditors((e) => {
          for (const { document: document2 } of e) {
            const syncedBuffer = this.syncedBuffers.get(document2.uri);
            if (syncedBuffer) {
              this.requestDiagnostic(syncedBuffer);
            }
          }
      ...
      openTextDocument(document2) {
        if (!this.modeIds.has(document2.languageId)) {
          return false;
        }
        const resource = document2.uri;
        const filepath = this.client.toTsFilePath(resource);
        ...
        const syncedBuffer = new SyncedBuffer(document2, filepath, this.client, this.synchronizer);
      ...
      onDidCloseTextDocument(document2) {
        this.closeResource(document2.uri);
      }
      ...
      shouldValidate(buffer) {
        if (isOfScheme(buffer.resource, chatCodeBlock, chatBackingCodeBlock)) {
          return false;
        }
...
var path7, RelativeWorkspacePathResolver;
...
var path8, TypeScriptPluginPathsProvider;
...
function getReportIssueArgsForError(error, tsServerLog, globalPlugins) {
  ...
  const sections = [
    ...
    `**TypeScript Version:** ${(_a = error.version.apiVersion) == null ? void 0 : _a.fullVersionString}`,
...
var path9, import_os, ServerState, emptyAuthority, inMemoryResourcePrefix, TypeScriptServiceClient, ServerInitializingIndicator;
var init_typescriptServiceClient = __esm({
  "src/typescript-language-features/src/typescriptServiceClient.ts"() {
    ...
    TypeScriptServiceClient = class extends Disposable {
          ...
          prompt == null ? void 0 : prompt.then(async (item) => {
            ...
            if (item === reportIssueItem) {
              ...
              if (tsVersion.isYarnPnp()) {
                ...
                const args = previousState.type === 2 /* Errored */ && previousState.error instanceof TypeScriptServerError ? getReportIssueArgsForError(previousState.error, previousState.tsServerLog, this.pluginManager.plugins) : void 0;
                commands.executeCommand("workbench.action.openIssueReporter", args);
              }
            }
          });
          if (startService) {
      ...
      toOpenTsFilePath(document2, options = {}) {
        if (!this.bufferSyncSupport.ensureHasBuffer(document2.uri)) {
          if (!options.suppressAlertOnFailure && !disabledSchemes.has(document2.uri.scheme)) {
            console.error(`Unexpected resource ${document2.uri}`);
          }
          return void 0;
        }
        return this.toTsFilePath(document2.uri);
      }
      ...
      dispatchEvent(event) {
        ...
        switch (event.event) {
          ...
          case "createDirectoryWatcher" /* createDirectoryWatcher */: {
            ...
            if (process.platform === "darwin" && fpath === path9.join((0, import_os.homedir)(), "Library")) {
              return;
            }
    ...
    ServerInitializingIndicator = class extends Disposable {
      ...
      startedLoadingProject(projectName) {
        this.reset();
        const projectDisplayName = workspace.asRelativePath(projectName);
        window.withProgress({
          location: 10 /* Window */,
          title: l10n.t("Initializing project '{0}'", projectDisplayName)
        }, () => new Promise((resolve) => {
    ...
    ((IntellisenseState2) => {
      ...
      class Pending {
        constructor(resource, projectType) {
          ...
          this.type = 1 /* Pending */;
          this.cancellation = new import_vscode_languageserver_protocol5.CancellationTokenSource();
        }
      }
...
var path10, updateImportsOnFileMoveName, UpdateImportsOnFileRenameHandler;
    ...
    TypeScriptWorkspaceSymbolProvider = class _TypeScriptWorkspaceSymbolProvider {
      ...
      async provideWorkspaceSymbols(search, token) {
        ...
        if (this.searchAllOpenProjects) {
          ...
          file2 = document2 ? await this.toOpenedFiledPath(document2) : void 0;
      ...
      async toOpenedFiledPath(document2) {
        var _a;
        if (document2.uri.scheme === git) {
          try {
            const path15 = Uri.file((_a = JSON.parse(document2.uri.query)) == null ? void 0 : _a.path);
            if (doesResourceLookLikeATypeScriptFile(path15) || doesResourceLookLikeAJavaScriptFile(path15)) {
              const document3 = await workspace.openTextDocument(path15);
              return this.client.toOpenTsFilePath(document3);
            }
          } catch {
          }
        }
      ...
      toSymbolInformation(item) {
        ...
        if (isOfScheme(uri, chatCodeBlock, chatBackingCodeBlock)) {
          return;
        }
      ...
      getDocument() {
        ...
        for (const document2 of documents) {
          if (this.modeIds.includes(document2.languageId)) {
            return document2;
          }
        }
        return void 0;
  ...
  "src/typescript-language-features/src/typeScriptServiceClientHost.ts"() {
    ...
    TypeScriptServiceClientHost = class extends Disposable {
      constructor(descriptions, context, onCaseInsensitiveFileSystem2, services, onCompletionAccepted) {
        ...
        Promise.resolve().then(() => (init_updatePathsOnRename(), updatePathsOnRename_exports)).then((module2) => this._register(module2.register(this.client, this.fileConfigurationManager, (uri) => this.handles(uri))));
        Promise.resolve().then(() => (init_workspaceSymbols(), workspaceSymbols_exports)).then((module2) => this._register(module2.register(this.client, allModeIds)));
...
var fs3, NodeRequestCanceller, nodeRequestCancellerFactory;
...
var fs4, path11, NodeLogDirectoryProvider;
...
var child_process, fs5, path12, defaultSize, contentLength, contentLengthSize, blank, backslashR, backslashN, ProtocolBuffer, Reader, IpcChildServerProcess, StdioChildServerProcess, ElectronServiceProcessFactory;
...
var fs6, path13, import_module, import_url, req, DiskTypeScriptVersionProvider;
var init_versionProvider_electron = __esm({
  "src/typescript-language-features/src/tsServer/versionProvider.electron.ts"() {
    ...
    req = (0, import_module.createRequire)(importMetaUrl);
    DiskTypeScriptVersionProvider = class _DiskTypeScriptVersionProvider {
      ...
      getContributedVersion(source, extensionId, pathToTs) {
        try {
          const tsPath = req.resolve("typescript", { paths: [(0, import_url.fileURLToPath)(importMetaUrl)] });
...
var os3, path14, child_process2, fs7, ElectronServiceConfigurationProvider;
...
__export(src_exports, {
  DocumentNotOpenedError: () => DocumentNotOpenedError,
  ProviderNotFoundError: () => ProviderNotFoundError,
  codeActionKinds: () => codeActionKinds,
  commands: () => commands2,
  completionTriggerCharacters: () => completionTriggerCharacters,
  createTSLanguageService: () => createTSLanguageService,
  onTypeFormatFirstTriggerCharacter: () => onTypeFormatFirstTriggerCharacter,
  onTypeFormatMoreTriggerCharacter: () => onTypeFormatMoreTriggerCharacter,
...
// src/service/main.ts
init_cjs_shims();
var lsp12 = __toESM(require("vscode-languageserver-protocol"));
var import_vscode_uri10 = require("vscode-uri");
init_share();
init_shims();
init_types2();
init_barrier();
...
init_cjs_shims();
var lsp8 = __toESM(require("vscode-languageserver-protocol"));
  ...
  constructor(clientCapabilities) {
      ...
      if (hasResourceOp) {
        return {
          documentChanges: docChanges.map((d) => {
            if (!import_vscode_uri8.URI.isUri(d)) {
              return d;
            } else {
              return {
      ...
      if (diagnostic.relatedInformation) {
        d.relatedInformation = diagnostic.relatedInformation.map((r) => {
          const location = new Location(
            import_vscode_uri8.URI.parse(r.location.uri),
    ...
    this.convertCallHierarcgyItemFromLsp = (item) => {
      return new CallHierarchyItem(
        ...
        item.name,
        item.detail ?? "",
        import_vscode_uri8.URI.parse(item.uri),
        Range.of(item.range),
...
init_cjs_shims();
var lsp9 = __toESM(require("vscode-languageserver-protocol"));
init_types2();
...
init_cjs_shims();
var import_vscode_fuzzy = require("@vtsls/vscode-fuzzy");
var lsp10 = __toESM(require("vscode-languageserver-protocol"));
init_types2();
init_dispose2();
init_types();
...
var TSCompletionFeature = class extends Disposable {
  ...
  getCompletionItemFuzzyScorer(itemsLen, position, wordRange, leadingLineContent) {
    const scoreFn = itemsLen > 2e3 ? import_vscode_fuzzy.fuzzyScore : import_vscode_fuzzy.fuzzyScoreGracefulAggressive;
    let word = "";
    let wordLow = "";
    return (item) => {
      var _a, _b;
      ...
      if (wordLen === 0) {
        return import_vscode_fuzzy.FuzzyScore.Default;
      } else {
        let wordPos = 0;
...
init_cjs_shims();
var lsp11 = __toESM(require("vscode-languageserver-protocol"));
...
__export(package_nls_exports, {
  "codeActions.refactor.extract.constant.description": () => codeActions_refactor_extract_constant_description,
  "codeActions.refactor.extract.constant.title": () => codeActions_refactor_extract_constant_title,
  "codeActions.refactor.extract.function.description": () => codeActions_refactor_extract_function_description,
  "codeActions.refactor.extract.function.title": () => codeActions_refactor_extract_function_title,
  "codeActions.refactor.extract.interface.description": () => codeActions_refactor_extract_interface_description,
  "codeActions.refactor.extract.interface.title": () => codeActions_refactor_extract_interface_title,
  "codeActions.refactor.extract.type.description": () => codeActions_refactor_extract_type_description,
  "codeActions.refactor.extract.type.title": () => codeActions_refactor_extract_type_title,
  "codeActions.refactor.move.newFile.description": () => codeActions_refactor_move_newFile_description,
  "codeActions.refactor.move.newFile.title": () => codeActions_refactor_move_newFile_title,
  "codeActions.refactor.rewrite.arrow.braces.description": () => codeActions_refactor_rewrite_arrow_braces_description,
  "codeActions.refactor.rewrite.arrow.braces.title": () => codeActions_refactor_rewrite_arrow_braces_title,
  "codeActions.refactor.rewrite.export.description": () => codeActions_refactor_rewrite_export_description,
  "codeActions.refactor.rewrite.export.title": () => codeActions_refactor_rewrite_export_title,
  "codeActions.refactor.rewrite.import.description": () => codeActions_refactor_rewrite_import_description,
  "codeActions.refactor.rewrite.import.title": () => codeActions_refactor_rewrite_import_title,
  "codeActions.refactor.rewrite.parameters.toDestructured.title": () => codeActions_refactor_rewrite_parameters_toDestructured_title,
  "codeActions.refactor.rewrite.property.generateAccessors.description": () => codeActions_refactor_rewrite_property_generateAccessors_description,
  "codeActions.refactor.rewrite.property.generateAccessors.title": () => codeActions_refactor_rewrite_property_generateAccessors_title,
  "codeActions.source.organizeImports.title": () => codeActions_source_organizeImports_title,
...
var configuration_tsserver_experimental_enableProjectDiagnostics = "(Experimental) Enables project wide error reporting.";
...
var typescript_preferences_organizeImports_typeOrder_last = "Type only named imports are sorted to the end of the import list.";
var typescript_preferences_organizeImports_typeOrder_inline = "Named imports are sorted by name only.";
var typescript_preferences_organizeImports_typeOrder_first = "Type only named imports are sorted to the end of the import list.";
...
var typescript_preferences_organizeImports_locale = "Overrides the locale used for collation. Specify `auto` to use the UI locale. Only applies to `organizeImportsCollation: 'unicode'`.";
var typescript_preferences_organizeImports_caseFirst = "Indicates whether upper-case comes before lower-case. Only applies to `organizeImportsCollation: 'unicode'`.";
var typescript_preferences_organizeImports_numericCollation = "Sort numeric strings by integer value.";
var typescript_preferences_organizeImports_accentCollation = "Compare characters with diacritical marks as unequal to base character.";
...
var codeActions_refactor_extract_constant_title = "Extract constant";
var codeActions_refactor_extract_constant_description = "Extract expression to constant.";
var codeActions_refactor_extract_function_title = "Extract function";
var codeActions_refactor_extract_function_description = "Extract expression to method or function.";
var codeActions_refactor_extract_type_title = "Extract type";
var codeActions_refactor_extract_type_description = "Extract type to a type alias.";
var codeActions_refactor_extract_interface_title = "Extract interface";
var codeActions_refactor_extract_interface_description = "Extract type to an interface.";
var codeActions_refactor_rewrite_import_title = "Convert import";
var codeActions_refactor_rewrite_import_description = "Convert between named imports and namespace imports.";
var codeActions_refactor_rewrite_export_title = "Convert export";
var codeActions_refactor_rewrite_export_description = "Convert between default export and named export.";
var codeActions_refactor_move_newFile_title = "Move to a new file";
var codeActions_refactor_move_newFile_description = "Move the expression to a new file.";
var codeActions_refactor_rewrite_arrow_braces_title = "Rewrite arrow braces";
var codeActions_refactor_rewrite_arrow_braces_description = "Add or remove braces in an arrow function.";
var codeActions_refactor_rewrite_parameters_toDestructured_title = "Convert parameters to destructured object";
var codeActions_refactor_rewrite_property_generateAccessors_title = "Generate accessors";
var codeActions_refactor_rewrite_property_generateAccessors_description = "Generate 'get' and 'set' accessors";
var codeActions_source_organizeImports_title = "Organize Imports";
...
var configuration_updateImportsOnPaste = "Automatically update imports when pasting code. Requires TypeScript 5.6+.";
...
init_cjs_shims();
var import_vscode_languageserver_protocol6 = require("vscode-languageserver-protocol");
init_languageFeatures();
init_workspace();
...
var codeActionKinds = [
  import_vscode_languageserver_protocol6.CodeActionKind.Source,
  import_vscode_languageserver_protocol6.CodeActionKind.SourceFixAll,
  import_vscode_languageserver_protocol6.CodeActionKind.SourceOrganizeImports,
  import_vscode_languageserver_protocol6.CodeActionKind.QuickFix,
  import_vscode_languageserver_protocol6.CodeActionKind.Refactor,
  import_vscode_languageserver_protocol6.CodeActionKind.RefactorExtract,
  import_vscode_languageserver_protocol6.CodeActionKind.RefactorRewrite,
  import_vscode_languageserver_protocol6.CodeActionKind.RefactorExtract
];
  ...
  const tsLanguageService = {
    ...
    codeLensResolve: wrapRequestHandler(async (item, token) => {
      ...
      const refLens = new ReferencesCodeLens4(
        import_vscode_uri10.URI.parse(item.data.document),
        item.data.file,
